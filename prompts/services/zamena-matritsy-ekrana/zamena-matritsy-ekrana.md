...
```bash
./scripts/process_service.sh zamena-matritsy-ekrana prompts/Attachments/zamena-matritsy-ekrana/raw-video.mp4
...
```
6. QA: `python3 scripts/check_alpha_quality.py /tmp/svc-anim/zamena-matritsy-ekrana/frames_out --threshold 6` (автоматически в `process_service.sh` шаг 2.5)
