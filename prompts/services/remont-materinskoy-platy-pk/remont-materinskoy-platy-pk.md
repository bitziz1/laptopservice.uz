...
```bash
./scripts/service-animation/process_service.sh remont-materinskoy-platy-pk prompts/Attachments/remont-materinskoy-platy-pk/raw-video.mp4
...
```
6. QA: `python3 scripts/service-animation/check_alpha_quality.py /tmp/svc-anim/remont-materinskoy-platy-pk/frames_out --threshold 6` (автоматически в `process_service.sh` шаг 2.5)
