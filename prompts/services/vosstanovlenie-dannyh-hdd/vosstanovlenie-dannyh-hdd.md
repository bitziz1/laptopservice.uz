...
```bash
./scripts/process_service.sh vosstanovlenie-dannyh-hdd prompts/Attachments/vosstanovlenie-dannyh-hdd/raw-video.mp4
...
```
6. QA: `python3 scripts/check_alpha_quality.py /tmp/svc-anim/vosstanovlenie-dannyh-hdd/frames_out --threshold 6` (автоматически в `process_service.sh` шаг 2.5)
