...
```bash
./scripts/process_service.sh remont-videokarty-kompyutera prompts/Attachments/remont-videokarty-kompyutera/raw-video.mp4
...
```
6. QA: `python3 scripts/check_alpha_quality.py /tmp/svc-anim/remont-videokarty-kompyutera/frames_out --threshold 6` (автоматически в `process_service.sh` шаг 2.5)
