...
export const siteConfig: SiteConfig = {
  ...
  address: {
    ...
    landmark: "напротив Паркентского базара, рядом с магазином «Радиодетали»",
    fullAddress: "г. Ташкент, ул. Паркент, д. 11 (напротив Паркентского базара, рядом магазин «Радиодетали»)",
